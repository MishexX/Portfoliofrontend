export default function CloudManagement() {
  const technologies = [
    { name: "Aws", icon: "/cloudIcons/aws.png" },
    { name: "Azure", icon: "/cloudIcons/azure.png" },
    {
      name: "Google Cloud Platform (Computer Storage)",
      icon: "/cloudIcons/google-cloud.png",
    },
    { name: "Scripting & Automation", icon: "/cloudIcons/scripting.png" },
    { name: "Powershell", icon: "/cloudIcons/powershell.png" },
    { name: "Bash", icon: "/cloudIcons/bash.png" },
    { name: "Python", icon: "/cloudIcons/python.png" },
  ];
    ...
    <div className="min-h-screen bg-black max-w-full relative overflow-hidden flex flex-col items-center justify-center py-8 px-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 relative z-10">
        {technologies.map((tech, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center bg-[#2A1E38] rounded-lg p-3 w-28 h-28 sm:w-[140px] sm:h-[140px] shadow-md hover:scale-105 transition-transform"
          >
      ...
      <div className="absolute right-5 md:right-[100px] top-0 h-full z-0">
        <svg
      ...
      <div className="absolute right-10 md:right-[200px] top-0 h-[50%] z-0">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="4"
          height="100%"
      ...
      {["25%", "75%", "100%"].map((top, idx) => (
        ...
        >
          ...
          <div className="absolute right-5 md:right-[100px] top-[-6px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
              height="12"
