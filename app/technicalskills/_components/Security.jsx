export default function Security() {
  const technologies = [
    {
      ...
      icon: "/securityIcons/firewallconfiguration.png",
    },
    { name: "Endpoint Protection", icon: "/securityIcons/Endpoint.png" },
    { name: "MFA", icon: "/securityIcons/two-factor-authentication.png" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#18122B] to-[#0F0715] max-w-full relative overflow-hidden flex flex-col items-center justify-center py-8 px-4">
      {/* --- Decorative translucent VSCode-like code lines --- */}
      <div className="absolute inset-0 z-0 pointer-events-none select-none">
        <svg width="100%" height="100%" viewBox="0 0 1200 600" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-10">
          <text x="60" y="120" fontFamily="'Fira Mono', 'Consolas', monospace" fontSize="32" fill="#B39DDB">const user = &#123; name: 'Mikheil', role: 'Dev' &#125;;</text>
          <text x="60" y="170" fontFamily="'Fira Mono', 'Consolas', monospace" fontSize="32" fill="#9575CD">function secure() &#123;</text>
          <text x="100" y="210" fontFamily="'Fira Mono', 'Consolas', monospace" fontSize="32" fill="#80CBC4">  return user.role === 'Dev';</text>
          <text x="60" y="250" fontFamily="'Fira Mono', 'Consolas', monospace" fontSize="32" fill="#9575CD">&#125;</text>
          <text x="60" y="300" fontFamily="'Fira Mono', 'Consolas', monospace" fontSize="32" fill="#B39DDB">// Security first!</text>
        </svg>
      </div>
      {/* --- Heading --- */}
