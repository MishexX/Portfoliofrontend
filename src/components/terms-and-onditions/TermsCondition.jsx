    ...
    <section className="relative py-24 md:py-52 px-4 sm:px-6 lg:px-8 bg-[#0F0715] overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto relative flex flex-col lg:flex-row items-center justify-between h-full gap-8 md:gap-12">
        ...
        <div className="relative z-10 w-full lg:w-1/2 text-center lg:text-left">
          ...
          <h1
            style={{ WebkitTextStroke: "1px #8750F7" }}
            className="text-transparent absolute -left-4 md:-left-22 top-18 md:-top-35 text-[4rem] sm:text-[6rem] md:text-[10rem] lg:text-[13rem] xl:text-[18.8rem] select-none font-semibold z-0 opacity-30 md:opacity-100 whitespace-nowrap overflow-hidden"
          >
            Terms And Conditions
          </h1>

          {/* Gradient Text (Front) */}
          <h1 className="relative z-30 text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold bg-gradient-to-r from-[#8750F7] to-[#FFFFFF] bg-clip-text text-transparent mt-28 md:mt-40 lg:mt-20 whitespace-normal md:whitespace-nowrap">
            Terms And Conditions
          </h1>
        </div>
